...
send_mail('Hello', 'Very imp msg....','chimatasrilakshmi2001@gmail.com',['chimatasrilakshmi999@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'chimatasrilakshmi2001@gmail.com', cd['to']) #use[]
            sent=True;
    else:
	    form=EmailSendForm()
